...
//    ds.setPassword(environment.getProperty("jdbc.password", ""));
      ...
      ds.setUrl(environment.getProperty("jdbc.url", "jdbc:mysql://localhost:3306/aws?useUnicode=true&amp;characterEncoding=utf8"));
      ds.setUsername(environment.getProperty("jdbc.username", "root"));
      ds.setPassword(environment.getProperty("jdbc.password", "gree.123456"));
        return ds;
  }
  ...
  public ProcessEngineConfigurationImpl processEngineConfiguration() {
      ...
      processEngineConfiguration.setActivityFontName("楷体");  //设置中文
      processEngineConfiguration.setLabelFontName("楷体");
      processEngineConfiguration.setAnnotationFontName("楷体");
